...
exports.mergePropagatorCompositeConfig = exports.mergeHeadersConfig = exports.mergeResourceAttributesConfig = exports.parseConfigFile = exports.FileConfigFactory = void 0;
 ...
 */
function mergeHeadersConfig(headers, headers_list) {
    if (!headers && !headers_list) {
        return undefined;
    }
    const mergedHeaders = (0, core_1.parseKeyPairsIntoRecord)(headers_list ?? undefined);
...
exports.mergeHeadersConfig = mergeHeadersConfig;
/**
