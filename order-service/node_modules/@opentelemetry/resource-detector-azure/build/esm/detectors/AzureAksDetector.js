...
import { AKS_CLUSTER_RESOURCE_ID, AKS_CLUSTER_RESOURCE_ID_KEY, AKS_METADATA_FILE_PATH, CLOUD_RESOURCE_ID_RESOURCE_ATTRIBUTE, extractClusterNameFromResourceId, } from '../types';
/**
...
class AzureAksDetector {
    ...
    readAksMetadataContent() {
        ...
        if (stats.isDirectory()) {
            const keyPath = path.join(AKS_METADATA_FILE_PATH, AKS_CLUSTER_RESOURCE_ID_KEY);
    ...
    parseAksMetadata(content) {
        ...
        const resourceId = keyedResourceId ?? (bareValues.length === 1 ? bareValues[0] : undefined);
        if (resourceId) {
